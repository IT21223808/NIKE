...
const womenProducts = [
  { id: "5", name: "Nike Air Zoom", price: "$129.99", image: "/women/img1.avif" },
  { id: "6", name: "LeBron XV", price: "$179.99", image: "/women/img2.avif" },
  { id: "7", name: "Nike Windrunner", price: "$159.99", image: "/women/img3.jpg" },
  { id: "8", name: "NikeCourt Heritage ", price: "$139.99", image: "/women/img4.avif" },
];
...
export default function WomenSection({ onCartUpdate }) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.5, ease: "easeOut" }}
      >
        <h2 className="text-3xl text-black font-semibold">Women's Collection</h2>
      </motion.div>
      <motion.div
